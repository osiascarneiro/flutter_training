...
class _ShowSimpleMapState extends State<ShowSimpleMap> {
  ...
  static final LatLng _anotherLocation = const LatLng(45.509244, -122.633476);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(onPressed: _goToIntel, label: Text("Intel Corp."), icon: Icon(Icons.place),),
    );
  }
